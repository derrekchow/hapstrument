...
Range range = new Range(0.2, -0.2, 0.02, 0.14);
// Other values: new Range(0.095, -0.095, 0.022, 0.149)
...
void setup() {
  ...
  leftHaply = new Haply(this, 0, new CircleModel());
  
  Model modelA = new StringModel(range);
  Model modelB = new BowModel(this, range);
  //rightHaply = new Haply(this, 3, new MergeModel(modelA, modelB, range));
