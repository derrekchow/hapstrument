...
public class Right extends Haply {
  ...
  Right(PApplet _this, int index, Model model){
    super(_this, index, model);
  ...
  void set_data(){
    ...
    if(haplyBoard.data_available()){
      ...
      angles.set(haply.get_device_angles()); 
      posEE.set(haply.get_device_position(angles.array()));
